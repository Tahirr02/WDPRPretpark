...
namespace WdprPretparkDenhaag.Controllers
{
    ...
    public class AttractieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,MinimaleLeeftijd,AngstFactor,Foto,MinimaleLengte,Prijs,AantalLikes,Inschrijfplicht,AantalKerenPerDag,OpeningsTijd,SluitingsTijd")] Attractie attractie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Naam,MinimaleLeeftijd,AngstFactor,Foto,MinimaleLengte,Prijs,AantalLikes,Inschrijfplicht,AantalKerenPerDag,OpeningsTijd,SluitingsTijd")] Attractie attractie)
        {
            if (id != attractie.Id)
            {
                return NotFound();
