...
namespace WdprPretparkDenhaag.Controllers
{
    public class PlanningController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TotaleKosten,BezoekersId")] Planning planning)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TotaleKosten,BezoekersId")] Planning planning)
        {
            if (id != planning.Id)
            {
                return NotFound();
